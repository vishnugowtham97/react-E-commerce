...
import pr6 from "../../Assets/Images/product/f6.jpg";
import pr7 from "../../Assets/Images/product/f7.jpg";
import pr8 from "../../Assets/Images/product/f8.jpg";
              ...
              <div className="col-6 d-flex justify-content-center flex-column">
                <div className="product-details p-5">
                  ...
                  <div className="mb-4">
                    <p>
                      ₹{props.price}&nbsp;
                      <strike className="text-danger">500₹</strike>
                    </p>
                  </div>
