...
import { PRODUCTS, PRODUCTS1 } from "../Products/Products";
          ...
          <div className="card p-3 m-auto">
            <div className="card-body">
              ...
              <p className="card-text mb-3">
                Elevate your style with this stunning dress from {product.brand}
                . Perfect for any occasion, this dress combines fashion and
                comfort effortlessly. Embrace the latest trends with its
                exquisite design and attention to detail. Crafted with
                high-quality materials, this dress is a must-have for your
                wardrobe.
              </p>
